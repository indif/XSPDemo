...
DECLARE_DWORD_ACCUMULATOR_STAT(TEXT("NumRawMesh"), STAT_XSPLoader_NumRawMesh, STATGROUP_XSPLoader);
DECLARE_DWORD_ACCUMULATOR_STAT(TEXT("NumCylinderMesh"), STAT_XSPLoader_NumCylinderMesh, STATGROUP_XSPLoader);
DECLARE_DWORD_ACCUMULATOR_STAT(TEXT("NumEllipticalMesh"), STAT_XSPLoader_NumEllipticalMesh, STATGROUP_XSPLoader);
